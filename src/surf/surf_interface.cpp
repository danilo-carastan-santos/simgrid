...
#include <simgrid/plugins/temperature.h>   // FIXME: this plug-in should not be linked to the core

s_surf_model_description_t surf_plugin_description[] = {
    {"Energy", "Cpu energy consumption.", &sg_host_energy_plugin_init},
	{"Temperature", "Cpu temperature monitoring.", &sg_host_temperature_plugin_init},
